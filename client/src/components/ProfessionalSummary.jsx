    ...
    return (
        <div className='space-y-4'>
            ...
            text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
                    ...
                    {isGenerating ? 'Enchancing...' : 'AI Enhance'}
                </button>
            </div>
            <div className='mt-6'>
                <textarea value={data || ""} onChange={(e) => onChange(e.target.value)} className='w-full p-3 -x-4 mt-2 boder text-sm
             border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500
            outline-none transition-colors resize-none' name="" id="" rows={7} placeholder='Write a compelling professional summary that 
