                    ...
                    {data.map((education, index) => (
                        <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                            ...
                            <div className='grid md:grid-cols gap-3'>
                                <input type="text" placeholder='Institution Name' value={education.institution || ""}
                                ...
                                <input type="month" value={education.graduation_date || ""}
                                    onChange={(e) => updateEducation(index, "graduation_date", e.target.value)} className='px-3 py-2 text-sm' />
                            </div>
