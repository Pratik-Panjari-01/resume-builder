  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            ...
            <button className="flex items-center gap-2 px-3 py-2 text-sm bg-blue-600 text-white rounded hover:bg-blue-700
            transition-colors duration:opacity-50 disabled:cursor-not-allowed" onClick={addSkill} disabled={!newSkill.trim()}>
