import { FilePenLineIcon, XIcon, PlusIcon, TrashIcon, UploadCloudIcon, Upload, UploadCloud, PencilIcon, LoaderCircleIcon } from 'lucide-react'
    ...
    <div>
      <div className="max-w-7xl mx-auto py-8 px-4">
        ...
        <div className="flex gap-4">
          ...
          rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg
          transition-all duration-300 cursor-pointer">
            ...
            <p className="text-sm group-hover:text-indigo-600 transtion-all duration-300">Create Resume</p>
          </button>
          ...
          rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-purple-500 hover:shadow-lg
          transition-all duration-300 cursor-pointer">
            ...
            <p className="text-sm group-hover:text-purple -600 transtion-all duration-300">Upload Existing</p>
          </button>
        </div>
        ...
        {showCreateResume && (
          <form action="" onSubmit={createResume} onClick={() => setShowCreateResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50
          z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              <h2 className='text-xl font-bold mb-4'>Create a Resume</h2>
              <input onChange={(e) => setTitle(e.target.value)} value={title} type='text' placeholder='Enter resume title' className='w-full px-4 py-2 mb-4 focus:border-green-600
        ...
        {showUploadResume && (
          <form action="" onSubmit={uploadResume} onClick={() => setShowUploadResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50
          z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
        ...
        {editResumeId && (
          <form action="" onSubmit={editTitle} onClick={() => setEditResumeId("")} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50
          z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
